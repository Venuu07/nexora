...
export default function App() {
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden font-sans flex flex-col">
      ...
      {/* Main Wall */}
<main className="flex-grow max-w-7xl mx-auto p-4 md:p-8 pt-8 relative w-full">        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-x-4 gap-y-12">
          <AnimatePresence>
